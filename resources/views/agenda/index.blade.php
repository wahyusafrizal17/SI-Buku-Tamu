         ...
         <div class="content-header row" >
            <div class="content-header-left col-md-9 col-12 mb-1">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Agenda</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('agenda-dan-kegiatan.index') }}">Agenda</a>
                                </li>
                                       ...
                                       <tr>
                                         ...
                                         <td class="text-center">
                                             <div class="form-button-action">
                                                <a href="{{ route('agenda-dan-kegiatan.edit',[$row->id]) }}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-sm" data-original-title="Edit">
...
$(document).ready(function() {
   ...
   $('.delete').click(function(e) {
      ...
      swal({
         ...
         if (Delete) {
            $.ajax({
               url: '{{ route('agenda-dan-kegiatan.delete') }}',
               method: 'post',
               cache: false,
               data: {
                  "_token": "{{ csrf_token() }}",
