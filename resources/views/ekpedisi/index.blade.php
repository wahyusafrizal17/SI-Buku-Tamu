         ...
         <div class="content-header row" >
            <div class="content-header-left col-md-9 col-12 mb-1">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Ekpedisi</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('ekpedisi-surat.index') }}">Ekpedisi</a>
                                </li>
                                 ...
                                 <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td>{{ $row->tujuan }}</td>
                                          <td><img src="{{ asset('ekpedisi/'.$row->foto_penyerahan_surat) }}" alt="" width="50%"></td>
                                         <td class="text-center">
                                             <div class="form-button-action">
                                                <a href="{{ route('ekpedisi-surat.edit',[$row->id]) }}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-sm" data-original-title="Edit">
...
$(document).ready(function() {
   ...
   $('.delete').click(function(e) {
      ...
      swal({
         ...
         if (Delete) {
            $.ajax({
               url: '{{ route('ekpedisi-surat.delete') }}',
               method: 'post',
               cache: false,
               data: {
                  "_token": "{{ csrf_token() }}",
